...
<div class="container">
    ...
    <form action="{{ route('status.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="status" class="form-label" style="color:rgb(250, 152, 5);">Cor do Status</label>
            <input type="text" class="form-control" id="status" name="status" value="{{ old('status') }}" required style="color:rgb(250, 152, 5);">
        </div>
